...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<div class="container">
			<ul class="navbar-nav">
			    <li class="nav-item">
					<a class="nav-link" href="/macbook-air/">MacBook Air
						<span class="chapternav-new">New</span>
					</a>
			    </li>	      
			     <li class="nav-item">
					<a class="nav-link" href="/macbook-pro-13/">
						<span class="#" >MacBook Pro 13형</span>
						<span class="#">New</span>
					</a>
				</li>
			    <li class="nav-item">
					<a class="nav-link" href="/macbook-pro-16/">
						<span class="#">MacBook Pro 16형</span>
					</a>
				</li>
			    <li class="nav-item">
					<a class="nav-link" href="/imac/">
						<span class="#">iMac</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/imac-pro/">
						<span class="#">iMac Pro</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/mac-pro/">
						<span class="#" role="text">Mac Pro</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/mac-mini/">
						<span class="#" role="text">Mac mini</span>
						<span class="#">New</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/mac/compare/">
						<span class="#" role="text">비교하기</span>
						<span class="#">Mac 모델</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/pro-display-xdr/">
						<span class="#" role="text">Pro Display XDR</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/shop/goto/mac/accessories">
						<span class="#" role="text">액세서리</span>
						<span class="visuallyhidden">Mac용</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/macos/big-sur/">
						<span class="#" role="text">Big Sur</span>
					</a>
				</li>
			</ul>
			<div class="nav-item">
				<button class="paddle-left">이미지</button>
				<button class="paddle-right">이미지</button>
			</div>  
		</div>
	</nav>
	<nav class="navbar navbar-expand-sm bg-secondary navbar-dark">
	  <ul class="navbar-nav">
	   	<li class="nav-item active">
	     	<a class="nav-link" href="#">Apple 교육 할인 스토어에서 신형 MacBookAir가 ₩1,160,000부터. 여기에 AirPods까지 덤으로.
	      		<a class="nav-link" href="https://www.apple.com/kr-k12/shop/back-to-school">쇼핑하기</a>
	   		</a>
	    </li>
	  </ul>
	</nav>
...
<div class="container" style="background-color : #f2f2f2;">
	<div class="container-box">
		<div class="slider-slide" style="width: 1400px; margin-right: 50px; display: inline-block; white-space: normal;">
			<ul>
					<li class="box1">
						<div class="MacBook Air" style="float : left; margin-right: 100px;">
							<a href="https://www.apple.com/kr-k12/shop/buy-mac/macbook-air">
								<div class="thumb">
									<img class=" macbook-air" src="https://www.apple.com/v/mac/home/ba/images/overview/compare/macbook_air__bfz9o93hnyuq_large.jpg">
								</div>							
								<div class="info">
									<div class="c-flag">
										<dl>
											...
											<dd>
												<span class="#">₩1,290,000부터</span>
											</dd>
										</dl>
									</div>
									<div class="#">
										<strong>13.3형 Retina 디스플레이1</strong>
									</div>
									<div class="#">
										<dl class="price">
											<dt>Apple M1 칩</dt>
										...
										<dl class="#">
											<dd>
												<span class="value">최대 16GB 메모리</span>
											</dd>
											<dd>
												<span class="value">최대 2TB 저장 장치</span>
											</dd>
											<dd>
												<span class="value">최대 18시간의 배터리 사용 시간</span>
											</dd>
										</dl>
									</div>
									<div class="pride">
										<span class="text">구입하기</span>
									</div>
									<div class="pride">
										<span class="number">더</span>알아보기
									</div>
								</div>
							</a>
						</div>
					...
					<li class="MacBook Air" style="float : left; margin-right: 100px;">
						<a href="https://www.apple.com/kr-k12/shop/buy-mac/macbook-air">
							...
							<div class="c_card_info">
								...
								<div class="#">
									<strong>13.3형 Retina 디스플레이</strong>
								</div>
								<div class="#">
									<dl class="price">
										<dt>Apple M1 칩</dt>
										<div class="#">
											<span class="text">Intel Core i5 또는 i7 프로세서로 구성 가능</span>
										</div>
									</dl>
									<dl class="#">
										<dd>
										...
										<dd>
											<span class="value">최대 20시간의 배터리 사용 시간</span>
										</dd>
									</dl>
								</div>
					...
					<li class="MacBook Air" style="float : left; margin-right: 100px;">
						<a href="https://www.apple.com/kr-k12/shop/buy-mac/macbook-air">
							...
							<div class="c_card_info">
								<div class="c-flag">
									<dl>
										<strong>MacBook Pro 16형</strong>
										<dd>
											<span class="#">₩3,190,000부터</span>
										</dd>
									</dl>
								</div>
								<div class="#">
									<strong>16형 Retina 디스플레이</strong>
								</div>
								<div class="#">
									<dl class="price">
										<dt>Intel Core i7 또는 i9 프로세서</dt>
									</dl>
									<dl class="#">
										<dd>
											<span class="value">최대 64GB 메모리</span>
										</dd>
										<dd>
											<span class="value">최대 8TB 저장 장치</span>
										</dd>
										<dd>
											<span class="value">최대 11시간의 배터리 사용 시간</span>
										</dd>
									</dl>
								</div>
								<div class="prd_option">
			...
			<section class="ac-gf-sosumi" aria-label="Footnotes">
				...
				<ol>
					...
					<li id="#">테스트는 2020년 10월 Apple에서 Apple M1 칩 및 8코어 GPU를 탑재한 MacBook Air 시제품을 사용해 진행했으며, 해당 제품은 8GB RAM 및 512GB SSD로 구성되었습니다.
								...
								자세한 내용은 <span class="nowrap"><a href="#">apple.com/kr/batteries</a>를</span> 참고하십시오.
					</li>
					...
					<li id="#">무료 체험 기간이 끝나면 월 6,500원에 이용할 수 있습니다. 한 번 가입으로 가족 공유 그룹 내 식구 전체가 이용 가능합니다.
								...
								특정 제한 사항 및 기타 <span class="nowrap"><a href="#">약관</a>이</span> 적용됩니다.
					</li>
				</ol>
			</section>
			<nav class="#">
